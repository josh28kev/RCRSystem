...
public class Cliente_Modelo extends java.util.Observable{
    ...
    public void colocar_clientes(List<Cliente> rows, int n) {
        int[] cols = {Cliente_Modelo_Tabla.ae_id, Cliente_Modelo_Tabla.ae_nombre, Cliente_Modelo_Tabla.ae_telefono,Cliente_Modelo_Tabla.ae_direccion,Cliente_Modelo_Tabla.ae_contacto};
