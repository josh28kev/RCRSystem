...
public class Proveedor_Modelo extends java.util.Observable {
    ...
    public void colocar_proveedores(List<Proveedor> rows, int n) {
        int[] cols = {Proveedor_Modelo_Tabla.ae_id, Proveedor_Modelo_Tabla.ae_nombre, Proveedor_Modelo_Tabla.ae_telFijo, Proveedor_Modelo_Tabla.ae_telCelular, Proveedor_Modelo_Tabla.ae_lugar,Proveedor_Modelo_Tabla.ae_contatcto};
