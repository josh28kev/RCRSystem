...
public class Factura_Modelo_Tabla extends AbstractTableModel {
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (a_columnas[col]) {
            case ae_codigo:
                return v.obtener_lista_empaque().obtener_codigo_l();
            case ae_cliente:
                return v.obtener_lista_empaque().obtener_cliente().obtener_nombre_c();
            case ae_destino:
                return v.obtener_lista_empaque().obtener_destino();
            default:
                return "";
        }
    }
